...
model = dict(
    ...
    # TODO redo the yolox header to fit with the mmdet format, passing train_cfg and test_cfg
    # train_cfg = dict(
    #     assigner=dict(
    #         type='MaxIoUAssigner',
    #         pos_iou_thr=0.35,
...
log_level = 'INFO'
load_from = None
resume_from = None #'/raid/datazyp/Swin-Transformer-Object-Detection/work_dir_tineface_reim/latest.pth' #None

workflow = [('train', 1)]  # Workflow for runner. [('train', 1)] means there is only one workflow and the workflow named 'train' is executed once. The workflow trains the model by 12 epochs according to the total_epochs.
work_dir = 'work_dir_tinaface_yolox_head'
